...
export default function Home() {
  return (
    <main>
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center px-6 pt-16 pb-24 text-center overflow-hidden bg-gradient-to-b from-rose-50 to-white">
        ...
        <div className="absolute bottom-60 right-[10%] w-14 h-14 bg-rose-200 rounded-2xl -rotate-12 opacity-50 animate-float" style={{ animationDelay: '3s' }} />

        <div className="z-10 max-w-4xl">
          {/* Sparky the Owl Mascot */}
          <div className="mx-auto mb-8 w-32 h-32 relative">
            <div className="w-32 h-32 bg-rose-100 rounded-full flex items-center justify-center shadow-lg shadow-rose-100 animate-float">
              <span className="text-7xl">🦉</span>
            </div>
            <div className="absolute -top-2 -right-1 text-3xl rotate-12">🎓</div>
          </div>

          <p className="text-rose-600 font-bold text-lg mb-3 tracking-wide uppercase">Meet Sparky, Your Learning Buddy!</p>
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight text-slate-900">
            Learning Made <br />
            <span className="text-rose-600 bg-rose-100 px-5 py-1 rounded-3xl inline-block mt-2">Simple &amp; Fun</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/how-it-works" className="w-full sm:w-auto px-10 py-5 bg-rose-600 text-white rounded-3xl text-xl font-bold shadow-xl shadow-rose-200 bouncy-hover inline-block text-center">
              See How It Works
            </Link>
            <Link href="/about" className="w-full sm:w-auto px-10 py-5 bg-white border-2 border-rose-200 text-slate-700 rounded-3xl text-xl font-bold bouncy-hover inline-block text-center shadow-sm">
              About Our Mission
            </Link>
          </div>
        </div>
        ...
        <div className="mt-20 w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-xl shadow-rose-50 border-2 border-rose-100 bouncy-hover">
          ...
          <div className="bg-white rounded-3xl p-6 shadow-xl shadow-rose-50 border-2 border-emerald-100 bouncy-hover">
            <div className="w-full aspect-[4/3] bg-gradient-to-br from-emerald-50 to-rose-50 rounded-2xl flex flex-col items-center justify-center mb-4 p-4">
              <div className="w-full bg-white rounded-xl p-3 shadow-sm mb-2">
                <div className="w-3/4 h-2 bg-rose-200 rounded-full mb-2"><div className="w-1/2 h-2 bg-rose-500 rounded-full"></div></div>
                <div className="text-xs text-slate-500 font-semibold">What is 5 + 3?</div>
              </div>
              <div className="flex gap-2 w-full">
                <div className="flex-1 bg-rose-100 rounded-lg py-1 text-center text-xs font-bold text-rose-700">6</div>
                <div className="flex-1 bg-emerald-100 rounded-lg py-1 text-center text-xs font-bold text-emerald-700">8 ✓</div>
                <div className="flex-1 bg-rose-100 rounded-lg py-1 text-center text-xs font-bold text-rose-700">7</div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-xl shadow-rose-50 border-2 border-pink-100 bouncy-hover">
              ...
              <div className="w-full space-y-2">
                <div className="bg-white rounded-lg p-2 shadow-sm flex items-center gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="w-full h-1.5 bg-slate-100 rounded-full"><div className="w-3/4 h-1.5 bg-rose-500 rounded-full"></div></div>
                  </div>
                </div>
                <div className="bg-white rounded-lg p-2 shadow-sm flex items-center gap-2">
                  <span className="text-sm">🔬</span>
      ...
      <section className="px-6 py-24 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="md:col-span-2 md:row-span-2 bg-rose-50 p-8 rounded-3xl shadow-sm border-2 border-rose-100 bouncy-hover flex flex-col justify-between">
              <div>
              ...
              <div className="mt-6 flex items-center gap-3 flex-wrap">
                <div className="px-3 py-1 bg-rose-200 rounded-full text-xs font-bold text-rose-700">🎯 15,000+ Questions</div>
                <div className="px-3 py-1 bg-rose-200 rounded-full text-xs font-bold text-rose-700">📊 Real-Time Adapt</div>
                <div className="px-3 py-1 bg-rose-200 rounded-full text-xs font-bold text-rose-700">🔄 Retake Anytime</div>
              </div>
            </div>
            ...
            <div className="bg-rose-50 p-8 rounded-3xl shadow-sm border-2 border-rose-100 bouncy-hover">
              <span className="text-4xl mb-4 block">🎮</span>
      ...
      {/* Mission Section */}
      <section className="px-6 py-20 bg-gradient-to-b from-white to-rose-50">
      ...
      <section className="px-6 py-20 bg-white">
        <div className="max-w-4xl mx-auto bg-rose-600 rounded-[2rem] p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-rose-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/how-it-works" className="px-8 py-4 bg-white text-rose-600 rounded-2xl text-lg font-bold shadow-lg bouncy-hover">
              How It Works →
            </Link>
